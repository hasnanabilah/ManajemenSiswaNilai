...
<div class="mb-4">
    ...
    <h3 class="page-heading mb-1 mt-1">Tambah Nilai</h3>
    ...
    <div class="col-lg-7">
        <div class="card shadow-soft">
            <div class="card-header card-header-grad">
                <h5 class="mb-0"><i class="bi bi-journal-plus"></i> Form Tambah Nilai</h5>
            </div>
            <div class="card-body p-4">
                <form method="post" action="<?= base_url('nilai/tambah/' . $siswa->id_siswa) ?>">

                    <div class="mb-3">
                        <label class="form-label"><i class="bi bi-book"></i> Mata Pelajaran</label>
                        <input type="text" name="mata_pelajaran" class="form-control" placeholder="Contoh: Pemrograman Web" required>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-calendar3"></i> Semester</label>
                            <input type="text" name="semester" class="form-control" placeholder="Contoh: Ganjil 2025" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-123"></i> Nilai</label>
                            <input type="number" step="0.01" name="nilai" class="form-control" min="0" max="100" placeholder="0 - 100" required>
                        </div>
                    </div>
